...
class RPSGame():
    ...
    def _run_sim(self, export=False, fname='output.mp4'):
        ...
        if export:
            ani = anim.FuncAnimation(fig, updater, frames=self.frames, interval=30, repeat=False, blit=True)
